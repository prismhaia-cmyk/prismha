  ...
  return (
    <div className="relative min-h-screen bg-black text-white selection:bg-primary/30 selection:text-white">
      <SEO
        ...
        description="Política de privacidad de Prismha."
        url="https://www.prismha.com/politica-privacidad"
      />
      <Header />
      <div className="relative min-h-screen w-full flex flex-col items-center px-6 py-24">
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="space-y-10 text-white/80 leading-relaxed text-base bg-surface border border-white/10 p-8 md:p-12 rounded-3xl shadow-2xl">
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">1. Responsable del tratamiento</h2>
              <p>
                ...
                Email de contacto:{" "}
                <a href="mailto:prismhaia@gmail.com" className="text-primary hover:underline">
                  prismhaia@gmail.com
                </a><br />
                Ubicación: Madrid, España<br />
                Sitio web:{" "}
                <a href="https://www.prismha.com" className="text-primary hover:underline">
                  www.prismha.com
                </a>
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">2. Datos que recopilamos</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">3. Finalidad del tratamiento</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">4. Base legal</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">5. Conservación de los datos</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">6. Derechos del usuario</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">7. Seguridad de los datos</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">8. Uso de inteligencia artificial</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">9. Encargados del tratamiento</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">10. Cookies y analítica</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">11. Actualización</h2>
              <p>
